...
public class SokectService {
	...
	public static List<MusicSheet> queryMusicSheets() {
		...
		// mdwedsj md万恶的数据，啥字段都有可能为空，creatorID空都去死吧
//		List<MusicSheet> mdwedsj=DownloadResource.queryMusic();
//		for (MusicSheet musicSheet : mdwedsj) {
//			if(musicSheet.getCreatorId()==null || musicSheet.getCreatorId().isEmpty())
//				continue;
//			singleMusicSheet.add(musicSheet);
//		}
